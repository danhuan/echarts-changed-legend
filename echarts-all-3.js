    ...
    return function (t) {
            ...
            e.eachChild(function (l, u) {
                ...
                if ("horizontal" === t) {
                    ...
                    if(pagemode){
                        ...
                        //c > o || l.newline ? (r += s + i, a = 0, c = v, s = f.width) : s = Math.max(s, f.width)
                    }else{
                        c > o || l.newline ? (r += s + i, a = 0, c = v, s = f.width) : s = Math.max(s, f.width)
                    }
        ...
        t.exports = {
            layout: function (t, e, i) {
                ...
                if(e.get('pagemode')){//如果 legend 启用分页 modify by danhuan
                    o.box(
                        e.get('orient'),
                        t,
                        e.get('itemGap'),
                        r.width,
                        r.height,
                        e.get('pagemode') //modify by danhuan
                    );
                }
                if(!e.get('pagemode')){
                    o.box(e.get("orient"), t, e.get("itemGap"), r.width, r.height), n(t, e, i)
